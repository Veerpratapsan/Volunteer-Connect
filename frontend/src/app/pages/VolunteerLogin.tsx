    ...
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6 selection:bg-primary/20 selection:text-primary">
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-serif mb-3 tracking-tight text-foreground">Volunteer Login</h1>
          <p className="text-muted-foreground font-light text-lg">Sign in to find opportunities.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6 mt-6 border-t border-border/50 text-center">
              <p className="text-muted-foreground text-sm">
                ...
                <Link to="/volunteer/signup" className="text-primary font-medium hover:underline underline-offset-4">
                  Create Account
                </Link>
              </p>
            </div>
